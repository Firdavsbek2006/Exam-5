      ...
      <header className="site-header">
        <div className="header d-flex justify-content-between align-items-center">
          <div className="header__left d-flex">
            ...
            <label>
              ...
              <svg
                ...
                height="18"
                fill="currentColor"
                className="bi bi-slash-square svggg"
                viewBox="0 0 16 16"
              >
            ...
            <ul className="header__list">
              <li className="header__item">
                <a href="#link">Pull requests</a>
              </li>
              <li className="header__item">
                <a href="#link">Issues</a>
              </li>
              <li className="header__item">
                <a href="#link">Codespaces</a>
              </li>
              <li className="header__item">
          ...
          <div className="header__right d-flex">
            ...
            <div className="avatar-wr d-flex">
              <img
                src="https://avatars.githubusercontent.com/u/109199420?v=4"
                alt="Avatar"
                width="20"
                height="20"
                className="imgg"
