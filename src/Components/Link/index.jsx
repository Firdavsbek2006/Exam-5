...
const Index = () => {
  ...
  return (
    <>
      <ul className="link__list d-flex">
        <li className="link__item">
          <NavLink
            to="/"
            className={({ isActive }) => (isActive ? "font" : "fon")}
          >
            Overview
          </NavLink>
          <svg
            ...
            className="octicon octicon-book UnderlineNav-octicon hide-sm svg book"
          >
            <path
              fillRule="evenodd"
        ...
        <li className="link__item">
          ...
          <span className="span__rep">
            {rep.map((e) => {
              return e.public_repos;
            })}
          </span>
          <svg
            aria-hidden="true"
            ...
            width="16"
            data-view-component="true"
            className="octicon octicon-repo UnderlineNav-octicon hide-sm svg book"
          >
            <path
              fillRule="evenodd"
        ...
        <li className="link__item">
          ...
          <svg
            ...
            width="16"
            data-view-component="true"
            className="octicon octicon-table UnderlineNav-octicon hide-sm svg book"
          >
            x
            <path
              fillRule="evenodd"
        ...
        <li className="link__item">
          ...
          <svg
            ...
            width="16"
            data-view-component="true"
            className="octicon octicon-package UnderlineNav-octicon hide-sm svg book"
          >
            <path
              fillRule="evenodd"
        ...
        <li className="link__item">
          <Link>Stars</Link>
          <span className="span__star">42</span>
          <svg
            aria-hidden="true"
            height="16"
            viewBox="0 0 16 16"
            ...
            width="16"
            data-view-component="true"
            className="octicon octicon-star UnderlineNav-octicon hide-sm svg book"
          >
            <path
              fillRule="evenodd"
